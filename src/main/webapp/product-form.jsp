<%-- Created by IntelliJ IDEA. User: hamadaaljarrah Date: 2023-10-02 Time: 22:58 To change this template use File |
                                    ...
                                    <form action="/admin/add-product" method="post" enctype="multipart/form-data">
                                        <div class="product-form">
                                            ...
                                            <div class="coolinput" style="justify-content: space-between">
                                                <input type="text" placeholder="Produkt namn" name="name" id="name"
                                                    class="input" style="padding-bottom: 40px">
                                                <input type="text" placeholder="Antal" name="quantity" id="quantity"
                                                    class="input" style="padding-bottom: 40px">
                                                <input type="text" placeholder="Pris" name="price" id="price"
                                                    class="input" style="padding-bottom: 40px">
                                            </div>
                                        </div>
                                        <div class="coolinput" style="width: 637px;margin-top: 10px">
                                            ...
                                            <button type="submit" class="button1" style="margin-top: 10px"
                                                onclick="console.log('submit clicked')">Lägg till produkt</button>
                                        </div>
                                    </form>
                </div>
            </div>
