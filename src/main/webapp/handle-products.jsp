      ...
      <div class="layout-container">
          ...
          <div class="flex px-6 py-4 bg-[#f9f9f9] gap-4 rounded-md">
              ...
              <div class="flex items-center gap-8">
                  <form action="product-details?id=<%=product.getId()%>" method="get">
                      <button type="submit">
                  ...
                  <form action="edit-product?id=<%=product.getId()%>" method="post">
                      <button type="submit">
                  ...
                  <form action="delete-product?id=<%=product.getId()%>" method="post">
                      <button type="submit">
